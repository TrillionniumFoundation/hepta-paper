...
and currently records 14 candidates and 43 explicit gaps. The
[unmapped-command closure ledger](NODE_RUST_GAP_CLOSURE.md) binds each gap to
its Node entrypoint, a closure category, and the evidence required to remove it;
