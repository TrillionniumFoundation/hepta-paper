...
| `module.candidate-router` | `trusted_in_process` | `source_implemented` | `disabled` | `pure` | `source` | [spec](specs/candidate-router.md) | [manifest](manifests/candidate-router.v1.json) |
...
| `module.node-legacy-adapter` | `legacy_adapter` | `source_implemented` | `disabled` | `prepared_result_only` | `source` | [spec](specs/node-legacy-adapter.md) | [manifest](manifests/node-legacy-adapter.v1.json) |
...
| `module.performance-qualification` | `isolated_process` | `source_implemented` | `disabled` | `read_only` | `target_host` | [spec](specs/performance-qualification.md) | [manifest](manifests/performance-qualification.v1.json) |
...
| `module.rust-control-plane-service` | `host_service` | `source_implemented` | `disabled` | `prepared_result_only` | `source` | [spec](specs/rust-control-plane-service.md) | [manifest](manifests/rust-control-plane-service.v1.json) |
...
| `module.snapshot-builder` | `trusted_in_process` | `source_implemented` | `disabled` | `read_only` | `source` | [spec](specs/snapshot-builder.md) | [manifest](manifests/snapshot-builder.v1.json) |
