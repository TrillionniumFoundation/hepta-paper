...
| `EXT-HOST-STORAGE-001` | `GAP-HOST-002` | WAL, SIGKILL, corruption, backup and restore harness | dedicated destructive-test-mount operator and observer | broker host evidence plus independent review | forbidden |
