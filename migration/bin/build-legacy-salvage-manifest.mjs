...
const overrides = new Map([
  ...
  ['paperctl_modules/paper_production_stale_pass_invalidation_audit.py', { disposition: 'verified_behavioral_replacement', targets: ['paper-core/bin/release-evidence-bundle.mjs', 'paper-core/bin/release-evidence-input-snapshot.mjs'], evidence: ['paper-core/tests/release-evidence-selection.test.mjs'] }],
