...
function captureEvaluation(value) {
  ...
  return Object.freeze({
    ...
    utilityMicrounits: safeInteger(data.utilityMicrounits, Number.MIN_SAFE_INTEGER,
      Number.MAX_SAFE_INTEGER, 'verified_plan_evaluation_utility_invalid'),
...
function captureSelection(value, request) {
  ...
  if (typeof body.frontierExhausted !== 'boolean'
    || body.expandedNodes > body.expansionBudget) {
  ...
  const feasibleShape = body.selectedCandidateIds !== null
    && body.selectedCandidatePayloadHashes !== null
    && body.resourceUsage !== null
    && body.objectiveLowerBoundMicrounits !== null
    && body.objectiveUpperBoundMicrounits !== null
    && body.optimalityGapMicrounits !== null;
  if (body.status === 'optimal') {
    if (!feasibleShape || !body.frontierExhausted
      ...
      || stableStringify(body.proof) !== stableStringify({
    ...
    if (!feasibleShape || body.frontierExhausted
      || !body.proof.feasibleIncumbent || !body.proof.hardConstraintsSatisfied
      || body.proof.infeasibilityProven || body.proof.optimalSelectionProven) {
      throw failure('verified_plan_source_proof_inconsistent');
    }
  } else {
