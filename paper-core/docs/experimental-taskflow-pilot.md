# Experimental OpenClaw TaskFlow pilot

This explicitly experimental TaskFlow integration coordinates long-lived external waits for one
...
It is not wired into any production composition root. The pilot is disabled
unless `HEPTA_TASKFLOW_PILOT=1`. Its first and only
