...
This document records the current plan for migrating useful incremental
`paper_factory` code and assets into `hepta-paper`, then retiring the legacy
`paper_factory` executable control plane.

The source of truth is the repeatable audit:
