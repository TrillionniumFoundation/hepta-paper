//! Preserved legacy model_selection data contract; no runtime activation.
//! Source Git blob: fb918ca567885cd749b0a486becfdfb6c09b671e.
use hepta_codex_protocol::Sha256Digest;
use serde::{Deserialize, Serialize};
use thiserror::Error;

use super::calibration::CalibrationReportV1;
