...
pub struct PlanCertificateV1 {
    ...
    /// Exact optimum in exact mode; selected value in fallback mode.
    pub upper_bound_micros: i64,
    /// Exact-mode optimality gap, or zero for deterministic fallback semantics.
    pub optimality_gap_micros: u64,
...
pub fn select_plan_v1(
    ...
    let body = PlanCertificateBodyV1 {
        ...
        upper_bound_micros: selected.objective_micros,
        optimality_gap_micros: 0,
        mode,
        fallback_reason,
    };
