//! Preserved raw-byte diagnostic observation contract from the 2026-09-10 Rust branch.
//!
//! Source blob: `2da20018c57dca72db106966f832be5384c921db`.
//! This namespace is distinct from the request-bound production JSON observation adapter.
//! Caller-declared runtime, parity evidence and time are claims, not independently verified facts.
//! It performs no I/O or Node execution and grants no authority. The replay fence is in-memory;
//! callers must bound instance lifetime and persist their own durable replay decisions.
