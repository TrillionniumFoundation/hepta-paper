...
use hepta_campaign_writer::{
    CampaignWriterPolicyV1, CampaignWriterStoreV1, NodeStatusV1,
    WriterCutoverAuthorizationV1, WriterCutoverPolicyV1, WriterCutoverSubjectV1,
    WriterCutoverTrustStoreV1, WriterLeaseV1, inspect_writer_database_preimage_v1,
...
fn one_paper_fake_author_reviewer_path_recovers_without_duplicate_integration() {
    ...
    let lease = writer
        .acquire_writer(lease_request, 10)
        .expect("lease");
    writer
